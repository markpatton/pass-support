...
public class TestObjectCreator {
     ...
     * @throws Exception
     */
    public static Contributor createContributor(String contributorId, String userId) throws Exception {
     ...
     * @throws Exception
     */
    public static Deposit createDeposit(String depositId) throws Exception {
     ...
     * @throws Exception
     */
    public static Funder createFunder(String funderId) throws Exception {
     ...
     * @throws Exception
     */
    public static Grant createGrant(String grantId) throws Exception {
     ...
     * @throws Exception
     */
    public static  Journal createJournal(String journalId) throws Exception {
     ...
     * @throws Exception
     */
    public static Policy createPolicy(String policyId) throws Exception {
     ...
     * @throws Exception
     */
    public static Publication createPublication(String publicationId) throws Exception {
     ...
     * @throws Exception
     */
    public static Publisher createPublisher(String publisherId) throws Exception {
     ...
     * @throws Exception
     */
    public static Repository createRepository(String repositoryId) throws Exception {
     ...
     * @throws Exception
     */
    public static RepositoryCopy createRepositoryCopy(String repositoryCopyId) throws Exception {
     ...
     * @throws Exception
     */
    public static Submission createSubmission(String submissionId) throws Exception {
     ...
     * @throws Exception
     */
    public static User createUser(String userId) throws Exception {
        User user = new User();
        user.setId(userId);
